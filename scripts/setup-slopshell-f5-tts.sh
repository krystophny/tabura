...
# Everything goes into ~/.local/share/slopshell-f5-tts/
#
...
F5_DIR="${HOME}/.local/share/slopshell-f5-tts"
VENV_DIR="${F5_DIR}/venv"
REF_WAV="${HOME}/.local/share/slopshell-tts/reference.wav"
...
echo "  2. systemctl --user start slopshell-f5-tts.service"
echo "  3. Test:"
