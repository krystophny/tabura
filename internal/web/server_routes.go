...
func (a *App) Router() http.Handler {
	...
	r.Get("/api/tracks/active", a.handleActiveTrackGet)
	r.Put("/api/tracks/active", a.handleActiveTrackPut)
	r.Put("/api/tracks/active/project", a.handleActiveTrackProjectPut)
	r.Put("/api/tracks/active/action", a.handleActiveTrackActionPut)
