...
This document used to define Slopshell's extension/plugin runtime and the split
...
When Slopshell integrates optional external capabilities in the future, prefer:
...
Slopshell should therefore preserve or revise only the minimum API needed to call
