...
`v0.1.0` is the first minor pre-release milestone for Slopshell. It consolidates the web+codex+piper runtime baseline and improves voice turn-end reliability with frontend VAD auto-stop behavior.
