...
- Removed remaining `whisper.cpp` setup path references from Slopshell runtime/docs.
...
- Updated runtime docs to include explicit `slopshell-stt.service` voxtype sidecar usage.
- Added temporary voxtype source pin for Slopshell integrations:
