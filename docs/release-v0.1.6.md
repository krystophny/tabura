...
> `krystophny/slopshell`, not a private extension ecosystem.

## Scope

`v0.1.6` ships the first extension-host redesign in core Slopshell, preserves
...
- Added extension manifest format (`*.extension.json`) with:
  ...
  - `commands`
  - `ui_contributions`
  - `engine.slopshell` compatibility constraints
