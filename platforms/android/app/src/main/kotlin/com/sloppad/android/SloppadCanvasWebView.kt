...
fun SloppadCanvasWebView(
    ...
    AndroidView(
        modifier = modifier,
        factory = { context ->
            SloppadCanvasDisplayWebView(context).apply {
                ...
                webViewClient = object : WebViewClient() {
                    override fun onPageFinished(view: WebView, url: String?) {
                        ...
                        (view as? SloppadCanvasDisplayWebView)?.onContentRendered()
                    }
                }
            }
        },
...
private class SloppadCanvasDisplayWebView(
    context: Context,
) : WebView(context) {
    ...
    fun setEinkDisplay(enabled: Boolean) {
        ...
        if (enabled) {
            SloppadBooxEinkController.configureContentView(this)
            SloppadBooxEinkController.setWebViewContrastOptimize(this, true)
            return
        }
        pendingRefresh?.let(::removeCallbacks)
        pendingRefresh = null
        SloppadBooxEinkController.setWebViewContrastOptimize(this, false)
    }
    ...
    private fun scheduleRefresh() {
        ...
        val refresh = Runnable {
            SloppadBooxEinkController.refreshContentView(this)
        }
