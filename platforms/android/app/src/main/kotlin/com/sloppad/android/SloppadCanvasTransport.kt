...
class SloppadCanvasTransport(
    private val client: OkHttpClient,
    private val onArtifact: (SloppadCanvasArtifact) -> Unit,
    ...
    fun connect(baseUrl: String, sessionId: String) {
        ...
        val request = Request.Builder()
            .url(sloppadWsUrl(baseUrl, "canvas/$sessionId"))
            .build()
    ...
    suspend fun loadSnapshot(baseUrl: String, sessionId: String): SloppadCanvasArtifact? {
        return withContext(Dispatchers.IO) {
            val request = Request.Builder()
                .url(sloppadApiUrl(baseUrl, "canvas/$sessionId/snapshot"))
                .build()
