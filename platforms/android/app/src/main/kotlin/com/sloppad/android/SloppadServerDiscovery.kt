...
class SloppadServerDiscovery(
    context: Context,
    private val onServersChanged: (List<SloppadDiscoveredServer>) -> Unit,
    private val onError: (String) -> Unit,
) {
    private val nsdManager = context.getSystemService(Context.NSD_SERVICE) as NsdManager
    private val discovered = linkedMapOf<String, SloppadDiscoveredServer>()
    ...
    fun start() {
        ...
        val listener = object : NsdManager.DiscoveryListener {
            ...
            override fun onServiceFound(serviceInfo: NsdServiceInfo) {
                if (serviceInfo.serviceType != "_sloppad._tcp.") {
                    return
                }
                nsdManager.resolveService(serviceInfo, object : NsdManager.ResolveListener {
                    ...
                    override fun onServiceResolved(info: NsdServiceInfo) {
                        ...
                        discovered[id] = SloppadDiscoveredServer(
                            id = id,
        ...
        nsdManager.discoverServices("_sloppad._tcp.", NsdManager.PROTOCOL_DNS_SD, listener)
    }
