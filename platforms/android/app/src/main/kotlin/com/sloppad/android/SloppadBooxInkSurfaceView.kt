...
class SloppadBooxInkSurfaceView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
) : View(context, attrs) {
    private var touchHelper: TouchHelper? = null
    private val rawPoints = mutableListOf<SloppadInkPoint>()
    private var onCommit: (List<SloppadInkStroke>) -> Unit = {}
    ...
    private val callback = object : RawInputCallback() {
        override fun onBeginRawDrawing(active: Boolean, touchPoint: TouchPoint) {
            ...
            SloppadBooxEinkController.configureInkView(this@SloppadBooxInkSurfaceView)
        }
    ...
    fun setOnCommit(listener: (List<SloppadInkStroke>) -> Unit) {
        onCommit = listener
    }
    ...
    private fun ensureTouchHelper() {
        ...
        touchHelper = helper
        SloppadBooxEinkController.configureInkView(this)
    }
    ...
    private fun TouchPointList.toInkPoints(): List<SloppadInkPoint> {
