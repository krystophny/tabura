...
data class SloppadDisplayProfile(
    val isBoox: Boolean,
)

fun detectSloppadDisplayProfile(context: Context): SloppadDisplayProfile {
    return SloppadDisplayProfile(isBoox = isBooxDevice(context))
}
...
object SloppadBooxEinkController {
