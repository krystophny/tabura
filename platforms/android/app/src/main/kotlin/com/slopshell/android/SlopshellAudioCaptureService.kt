...
class SlopshellAudioCaptureService : Service() {
    interface Listener {
    ...
    inner class LocalBinder : Binder() {
        fun service(): SlopshellAudioCaptureService = this@SlopshellAudioCaptureService
    }
    ...
    private fun acquireWakeLock() {
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "slopshell:audio")
        wakeLock?.acquire()
    }
    ...
    companion object {
        private const val CHANNEL_ID = "slopshell-audio"
