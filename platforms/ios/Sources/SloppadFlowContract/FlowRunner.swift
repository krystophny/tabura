...
public final class FlowRunner {
    ...
    private func assertExpectations(_ expectations: FlowExpectations?) throws {
        ...
        if let sloppadCircle = expectations.sloppadCircle, snapshot.sloppadCircle != sloppadCircle {
            throw FlowRunnerError.expectationFailed("expected sloppad_circle \(sloppadCircle), got \(snapshot.sloppadCircle)")
        }
    ...
    private func snapshot() -> FlowSnapshot {
        ...
        return FlowSnapshot(
            ...
            session: state.session,
            silent: state.silent,
            sloppadCircle: state.circleExpanded ? "expanded" : "collapsed",
